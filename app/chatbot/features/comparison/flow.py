...
from app.real_estate import latest_trade_for_complex
from app.real_estate.poi import nearest_poi_for_complex

from ..common import clean_text, empty_result, normalize_slots
