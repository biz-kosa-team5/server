...
def test_chatbot_flow_packages_own_slot_extraction_and_execution():
  ...
  assert not Path("app/chatbot/service/answer/formatters/recommendation.py").exists()
  assert not Path("app/chatbot/service/answer/formatters/comparison.py").exists()
  assert not Path("app/chatbot/service/answer/formatters/legal_contract.py").exists()
