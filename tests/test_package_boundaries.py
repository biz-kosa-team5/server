...
def test_chatbot_flow_packages_own_slot_extraction_and_execution():
  ...
  assert Path("app/chatbot/service/answer").exists()
  assert Path("app/chatbot/service/answer/composer.py").exists()
  assert Path("app/chatbot/service/answer/formatters").exists()
  assert Path("app/chatbot/service/answer/formatters/simple_lookup.py").exists()
  assert Path("app/chatbot/service/answer/formatters/price_trend.py").exists()
  assert Path("app/chatbot/service/answer/formatters/recommendation.py").exists()
  assert Path("app/chatbot/service/answer/formatters/comparison.py").exists()
  assert Path("app/chatbot/service/answer/formatters/legal_contract.py").exists()
  assert not Path("app/chatbot/features/recommendation/rag_answer.py").exists()
  assert not Path("app/chatbot/features/comparison/rag_answer.py").exists()
  assert not Path("app/chatbot/features/legal_contract/rag/dto/answer.py").exists()
  assert not Path("app/chatbot/features/legal_contract/rag/service/answer_generator.py").exists()
  assert not Path("app/chatbot/features/legal_contract/rag/service/answer_prompt.py").exists()
  assert not Path("app/chatbot/features/legal_contract/rag/service/answer_response.py").exists()
  assert not Path("app/chatbot/features/legal_contract/rag/service/answer_service.py").exists()
  assert not Path("app/chatbot/service/answer_composer.py").exists()
  assert not Path("app/chatbot/service/answer_formatters").exists()
